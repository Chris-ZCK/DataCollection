...
void mqtt_UID_set(void)
{
	...
	printf("[INFO]*MQTT:MY_TOPIC_PICDOWN:%s\r\n",MY_TOPIC_PICDOWN);
	printf("[INFO]*MQTT:MY_TOPIC_PICUP  :%s\r\n",MY_TOPIC_PICUP);
	printf("[INFO]*MQTT:MY_TOPIC_MSGDOWN:%s\r\n",MY_TOPIC_MSGDOWN);
	printf("[INFO]*MQTT:MY_TOPIC_MSGUP  :%s\r\n",MY_TOPIC_MSGUP);
	printf("[INFO]*MQTT:MY_TOPIC_CONFIG :%s\r\n",MY_TOPIC_CONFIG);
}
